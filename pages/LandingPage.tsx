  ...
  return (
    <div className="landing">
      ...
      <main className="landing__main">
        ...
        <section
          id="try"
          className="landing__section landing__section--inverse"
        >
          <div className="landing__section-head">
            <p className="landing__eyebrow">Try generate</p>
            <h2>Play with the UI before you commit</h2>
            <p className="landing__section-copy">
              This is a preview of the in-app generator. Uploads and renders
              require a quick sign in. First image is on us, the next one is
              billed.
            </p>
          </div>
          <div className="try">
            <div className="try__left">
              <div className="try__field">
                <div className="try__label">Reference images</div>
                <div className="try__upload">
                  <button
                    className="primary-button landing__upload-button"
                    onClick={handleUploadClick}
                  >
              ...
              <div className="try__field">
                <div className="try__label">Prompt idea</div>
                <div className="try__textarea">
                  Confident LinkedIn portrait with soft daylight, teal accents,
                  and a subtle office background.
                </div>
              </div>
              <div className="try__foot">
                <div className="try__tags">
                  <span className="pill">Free render included</span>
                  <span className="pill pill--ghost">Next render billed</span>
                  <span className="pill pill--ghost">Sign in required</span>
                </div>
                <button className="primary-button" onClick={handleStart}>
                  Sign in to run it
                </button>
            ...
            <div className="try__right">
              <div className="try__preview-grid">
                <div className="mock-image mock-image--free">
                  <span>Free preview</span>
                </div>
                <div className="mock-image mock-image--paid">
                  <span>Billed render</span>
                </div>
                <div className="mock-image mock-image--accent">
                  <span>Slides & banners</span>
                </div>
              </div>
              <div className="try__note">
                Generate inside the dashboard. We hold your style so every image
                and slide matches—even when you change outfits or settings.
              </div>
            </div>
          </div>
        </section>
